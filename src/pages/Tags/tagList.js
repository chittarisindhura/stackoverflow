export const tagsList = [
  {
    tagName: "javascript",
    tagDesc:
      "For questions regarding programming in ECMASccript (javaScript/JS) and its various dialects/implementations (excluding ActionScript). please include all relevant tags on your question;",
  },
  {
    tagName: "python",
    tagDesc:
  ...
  },
  {
    tagName: "c#",
    tagDesc:
      "C# (pronounced 'see sharp') is a high level, statisticallly typed, multi-paradigm programming language developed by Microsoft",
  },
  ...
  },
  {
    tagName: "css",
    tagDesc:
      "CSS is a representation style sheet language used for describing the look and formatting of HTML, XML docments and SVG elements including colors, layout, fonts, and animations",
  },
  {
    tagName: "Reactjs",
    tagDesc:
